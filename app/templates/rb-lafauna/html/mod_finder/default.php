...
$output = '<input type="text" name="q" id="mod-finder-searchword' . $module->id . '" class="form-control" size="'
...
$labelClass = (!$showLabel ? 'element-invisible ' : '') . 'finder';
...
{
	$button = '<button class="btn-search hasTooltip" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="icon-search"></i></button>';
...
<form id="mod-finder <?php echo $module->id; ?>" action="<?php echo JRoute::_($route); ?>" method="get" class="form-inline">

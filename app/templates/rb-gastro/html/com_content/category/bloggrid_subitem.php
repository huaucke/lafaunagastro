...
<?php if ($this->item->state == 0 || strtotime($this->item->publish_up) > strtotime(JFactory::getDate())
	...
	<div class="system-unpublished">
		<?php endif; ?>
		<?php // imagen de grid.?>
		<?php echo JLayoutHelper::render('joomla.content.thumb_image', $this->item); ?>
		<?php // title de grid.?>
		<div class="nombre">
	...
	{		
		$content = "
					<label class='btn-toggle'>
						<i class='hasTooltip tip alergias' data-original-title='".$class."'></i>
					</label>
						<div class='popup'>
							<div class='popup-top'>
								<div class='btn-close'>
...
?>
<?php /* <div class="fields-container"></div> */ ?>
	<?php echo implode("\n", $output); ?>

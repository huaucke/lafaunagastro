...
>
	...
	<?php endif; ?>
		...
		<?php if ($disabled != true) : ?>
			<button type="button" class="button-select"><?php echo JText::_("JLIB_FORM_BUTTON_SELECT"); ?></button>
			<button type="button" class="hasTooltip button-clear" title="<?php echo JText::_("JLIB_FORM_BUTTON_CLEAR"); ?>" aria-label="<?php echo JText::_("JLIB_FORM_BUTTON_CLEAR"); ?>">
